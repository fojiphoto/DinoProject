...
namespace NeoFPS
{
	...
	public class InputCharacterMotion : CharacterInputBase
    {
		...
		protected MouseAndGamepadAimController m_Aimer = null;
        ...
        protected SwitchParameter m_CrouchProperty = null;
        private SwitchParameter m_CrouchHoldProperty = null;
        protected SwitchParameter m_SprintProperty = null;
        ...
        protected void CheckMotionGraphConnection()
        {
            if (!m_Initialised)
            {
